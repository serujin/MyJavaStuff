...
public class RAFFileHandler extends AFileHandler {
    ...
    public RAFFileHandler(File file, RafRegister register) throws IOException {
        super(file);
    ...
    public void addRegisterToFile(boolean append, Object[] objects) throws InvalidRAFRegisterValuesException {
